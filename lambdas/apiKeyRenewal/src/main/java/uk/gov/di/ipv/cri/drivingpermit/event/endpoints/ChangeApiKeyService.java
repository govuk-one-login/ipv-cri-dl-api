...
public class ChangeApiKeyService {
    ...
    public String sendApiKeyChangeRequest(String apiKey, String authorization)
        ...
        eventProbe.counterMetric(DVLA_API_KEY_REQUEST_CREATED.withEndpointPrefix());
        ...
        try (CloseableHttpResponse response =
            ...
            eventProbe.counterMetric(DVLA_API_KEY_REQUEST_SEND_OK.withEndpointPrefix());
            ...
            eventProbe.counterMetric(
                    DVLA_API_KEY_REQUEST_SEND_ERROR.withEndpointPrefixAndExceptionName(e));
        ...
        if (httpReply.statusCode == 200) {
            ...
            // Alarm Firing
            eventProbe.counterMetric(
                    DVLA_API_KEY_RESPONSE_STATUS_CODE_ALERT_METRIC.withEndpointPrefix());
