...
class ChangeApiKeyServiceTest {
    ...
    void shouldReturnApiKeyWhenRequestedFromThirdParty()
        ...
        inOrderMockEventProbeSequence
                ...
                .counterMetric(DVLA_CHANGE_API_KEY_REQUEST_CREATED.withEndpointPrefix());
        inOrderMockEventProbeSequence
                .verify(mockEventProbe)
                .counterMetric(DVLA_CHANGE_API_KEY_REQUEST_SEND_OK.withEndpointPrefix());
        inOrderMockEventProbeSequence
                .verify(mockEventProbe)
                .counterMetric(
    ...
    void shouldReturnOAuthErrorResponseExceptionWhenChangeApiKeyEndpointDoesNotRespond()
        ...
        inOrderMockEventProbeSequence
                .verify(mockEventProbe)
                .counterMetric(
                        DVLA_CHANGE_API_KEY_REQUEST_SEND_ERROR.withEndpointPrefixAndExceptionName(
                                exceptionCaught));
        verifyNoMoreInteractions(mockEventProbe);
