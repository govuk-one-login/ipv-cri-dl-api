...
public class ChangeApiKeyHttpRetryStatusConfig implements HttpRetryStatusConfig {
    ...
    public String httpRetryerSendOkMetric() {
        return DVLA_CHANGE_API_KEY_HTTP_RETRYER_REQUEST_SEND_OK.withEndpointPrefix();
    }

    @Override
    public String httpRetryerSendFailMetric(Exception e) {
        return DVLA_CHANGE_API_KEY_HTTP_RETRYER_REQUEST_SEND_FAIL
                .withEndpointPrefixAndExceptionName(e);
    }

    @Override
    public String httpRetryerSendErrorMetric() {
        return DVLA_CHANGE_API_KEY_HTTP_RETRYER_SEND_ERROR.withEndpointPrefix();
    }

    @Override
    public String httpRetryerSendRetryMetric() {
        return DVLA_CHANGE_API_KEY_HTTP_RETRYER_REQUEST_SEND_RETRY.withEndpointPrefix();
    }

    @Override
    public String httpRetryerMaxRetriesMetric() {
        return DVLA_CHANGE_API_KEY_HTTP_RETRYER_SEND_MAX_RETRIES.withEndpointPrefix();
    }
}
