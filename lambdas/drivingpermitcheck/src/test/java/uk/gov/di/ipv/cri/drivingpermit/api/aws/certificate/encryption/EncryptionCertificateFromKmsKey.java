...
public class EncryptionCertificateFromKmsKey {
    ...
    public static X509Certificate certificateFromKmsKey(String keyId) throws Exception {
        ...
        X509Certificate cert =
                generateSelfSignedCertificate(
                        keyId, "CN=Driving Licence CRI JSON Encryption Dev 25-06-2024");
    ...
    public static X509Certificate generateSelfSignedCertificate(String keyId, String subjectDN)
        ...
        AwsKmsContentEncryptor contentEncryptor =
                new AwsKmsContentEncryptor(keyId, encryptionAlgorithmSpec);
        ...
        return new JcaX509CertificateConverter()
                .setProvider("BC")
                .getCertificate(certBuilder.build(contentEncryptor));
    }
}
