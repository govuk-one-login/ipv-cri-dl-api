...
public enum ThirdPartyAPIEndpointMetric {
    ...
    DVLA_CHANGE_PASSWORD_REQUEST_SEND_OK(
            DVLA_THIRD_PARTY_API_CHANGE_PASSWORD_ENDPOINT, REQUEST_SEND_OK),

    DVLA_CHANGE_PASSWORD_REQUEST_SEND_ERROR(
            DVLA_THIRD_PARTY_API_CHANGE_PASSWORD_ENDPOINT, REQUEST_SEND_ERROR),

    DVLA_CHANGE_PASSWORD_RESPONSE_TYPE_VALID(
            DVLA_THIRD_PARTY_API_CHANGE_PASSWORD_ENDPOINT, API_RESPONSE_TYPE_VALID),
    DVLA_CHANGE_PASSWORD_RESPONSE_TYPE_INVALID(
            DVLA_THIRD_PARTY_API_CHANGE_PASSWORD_ENDPOINT, API_RESPONSE_TYPE_INVALID),
    DVLA_CHANGE_PASSWORD_RESPONSE_TYPE_EXPECTED_HTTP_STATUS(
            DVLA_THIRD_PARTY_API_CHANGE_PASSWORD_ENDPOINT, API_RESPONSE_TYPE_EXPECTED_HTTP_STATUS),
    ...
    DVLA_CHANGE_PASSWORD_HTTP_RETRYER_REQUEST_SEND_FAIL(
            DVLA_THIRD_PARTY_API_CHANGE_PASSWORD_ENDPOINT, HTTP_RETRYER_REQUEST_SEND_FAIL),
    DVLA_CHANGE_PASSWORD_HTTP_RETRYER_REQUEST_SEND_RETRY(
            DVLA_THIRD_PARTY_API_CHANGE_PASSWORD_ENDPOINT, HTTP_RETRYER_REQUEST_SEND_RETRY),
    DVLA_CHANGE_PASSWORD_HTTP_RETRYER_SEND_MAX_RETRIES(
            DVLA_THIRD_PARTY_API_CHANGE_PASSWORD_ENDPOINT, HTTP_RETRYER_SEND_MAX_RETRIES),
    DVLA_CHANGE_PASSWORD_HTTP_RETRYER_SEND_ERROR(
            DVLA_THIRD_PARTY_API_CHANGE_PASSWORD_ENDPOINT, HTTP_RETRYER_SEND_ERROR),
    ...
    DVLA_CHANGE_API_KEY_REQUEST_SEND_ERROR(DVLA_THIRD_PARTY_API_KEY_ENDPOINT, REQUEST_SEND_ERROR),

    DVLA_CHANGE_API_KEY_RESPONSE_TYPE_VALID(
            DVLA_THIRD_PARTY_API_KEY_ENDPOINT, API_RESPONSE_TYPE_VALID),
    DVLA_CHANGE_API_KEY_RESPONSE_TYPE_INVALID(
            DVLA_THIRD_PARTY_API_KEY_ENDPOINT, API_RESPONSE_TYPE_INVALID),
    DVLA_CHANGE_API_KEY_RESPONSE_TYPE_EXPECTED_HTTP_STATUS(
            DVLA_THIRD_PARTY_API_KEY_ENDPOINT, API_RESPONSE_TYPE_EXPECTED_HTTP_STATUS),
    DVLA_CHANGE_API_KEY_RESPONSE_TYPE_UNEXPECTED_HTTP_STATUS(
            DVLA_THIRD_PARTY_API_KEY_ENDPOINT, API_RESPONSE_TYPE_UNEXPECTED_HTTP_STATUS),

    DVLA_CHANGE_API_KEY_RESPONSE_LATENCY(DVLA_THIRD_PARTY_API_KEY_ENDPOINT, API_RESPONSE_LATENCY),

    DVLA_CHANGE_API_KEY_HTTP_RETRYER_REQUEST_SEND_OK(
            DVLA_THIRD_PARTY_API_KEY_ENDPOINT, HTTP_RETRYER_REQUEST_SEND_OK),
    DVLA_CHANGE_API_KEY_HTTP_RETRYER_REQUEST_SEND_FAIL(
            DVLA_THIRD_PARTY_API_KEY_ENDPOINT, HTTP_RETRYER_REQUEST_SEND_FAIL),
    DVLA_CHANGE_API_KEY_HTTP_RETRYER_REQUEST_SEND_RETRY(
            DVLA_THIRD_PARTY_API_KEY_ENDPOINT, HTTP_RETRYER_REQUEST_SEND_RETRY),
    DVLA_CHANGE_API_KEY_HTTP_RETRYER_SEND_MAX_RETRIES(
            DVLA_THIRD_PARTY_API_KEY_ENDPOINT, HTTP_RETRYER_SEND_MAX_RETRIES),
    DVLA_CHANGE_API_KEY_HTTP_RETRYER_SEND_ERROR(
