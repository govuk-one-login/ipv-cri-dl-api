...
class LambdaTemplateTest {
    ...
    private static <T> Optional<T> getPropertyTypeReference(
        ...
        LambdaTemplateTest.typeRef = typeRef;
        if (sourceMap != null && sourceMap.containsKey("MethodSettings")) {
            ...
            try {
                ...
                System.err.println(
                        "Type mismatch for property '" + "MethodSettings" + "': " + e.getMessage());
                return Optional.empty();
            }
        }
        return Optional.empty();
     ...
     *
     * @param properties The 'Properties' map of an AWS::CloudWatch::Alarm resource.
     * @param logicalId The logical ID of the alarm, used for debugging/error messages.
     * @return true if a valid 'MetricName' is found in either location, false otherwise.
     */
    private boolean hasMetricNameInAlarmProperties(
            Map<String, Object> properties, String logicalId) {
    ...
    void allCloudWatchAlarmResourcesShouldContainMetricName() {
        ...
        for (Map.Entry<String, Map<String, Object>> entry : alarmProperties.entrySet()) {
            ...
            if (!hasMetricNameInAlarmProperties(properties, logicalId)) {
