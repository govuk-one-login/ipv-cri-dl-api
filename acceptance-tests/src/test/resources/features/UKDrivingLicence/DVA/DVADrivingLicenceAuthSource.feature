...
#    And I click on DVA radio button and Continue
    And I check the page title is Check your UK photocard driving licence details
#    Given User enters DVA data as a <DVADrivingLicenceSubject>
    ...
    Examples:
      | DVADrivingLicenceAuthSourceSubject | DVADrivingLicenceSubject           |
      | DVAAuthSourceValidBillyJsonPayload | DVADrivingLicenceSubjectHappyBilly |
